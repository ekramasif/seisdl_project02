...
<div>
   <h1 align="center">List all Student</h1>
</div>
<div class = "col-md-12">
         ...
         <?php
               ...
               { ?>
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-primary" href="editstudent.php?id=<?php echo $row['id']?> ">Edit</a>
                           ...
                           <div class="modal-dialog">
                              <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                    <a class="btn btn-success" href="deletestudent.php?id=<?php echo $row['id']?> ">delete</a>
